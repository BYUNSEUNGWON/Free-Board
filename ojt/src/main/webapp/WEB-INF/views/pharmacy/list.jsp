		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="widget p-lg">
					<h4 class="m-b-lg">Pharmacy List</h4>
					<p class="m-b-lg docs"> 
					</p>
					<div class="text-right m-b-sm">
						<a href="register" class="btn btn-success btn-sm" role="button">Register New Pharmacy</a>
					</div>
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<c:forEach var="pharmacy" items="${list}">
								<tr>
									<td>${pharmacy.bno }</td>
									<td><a href="get${pageMaker.cri.listLink }&bno=${pharmacy.bno}">${pharmacy.title }</a></td>
									<td>${pharmacy.writer }</td>
									<td><fmt:formatDate value="${pharmacy.regdate }" pattern="yyyy-MM-dd"/></td>
									<td><fmt:formatDate value="${pharmacy.updateDate }" pattern="yyyy-MM-dd"/></td>
								</tr>

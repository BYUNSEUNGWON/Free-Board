			...
			<div class="col-md-6">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Hospital Modify/Delete Page</h4>
					...
					<div class="widget-body">
						...
						<form id="actionForm" action="/hospital/modify" method="post" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="title" id="title" placeholder="" required="required" value="${hospital.title}">
								</div>
							</div>
							<div class="form-group">
								<label for="content" class="col-sm-3 control-label">Text area:</label>
								<div class="col-sm-9">
									<textarea class="form-control" name="content" id="content" placeholder="" required="required">${hospital.content}</textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="writer" class="col-sm-3 control-label">Writer:</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="writer" id="writer" placeholder="" readonly="readonly" value="${hospital.writer}">
								</div>
							</div>
							<div class="form-group">
	...
	$("button[type=submit]").on("click", function(event){
		...
		if(operation === 'remove'){
			if(confirm("정말로 삭제하시겠습니까?")){
				$("#actionForm").attr("action", "/hospital/remove");
			} else {
				return false;
			}
		} else if(operation === 'list'){
			$("#actionForm").attr("action", "/hospital/list");

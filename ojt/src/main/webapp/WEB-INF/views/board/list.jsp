					...
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<c:forEach var="Diary" items="${list}">
								<tr>
									<td>${Diary.bno }</td>
									<td><a href="${Diary.bno}" class="move">${Diary.title }</a> 
									<span class="badge badge-primary">${Diary.replyCnt }</span></td>
									<td>${Diary.writer }</td>
									<td>${Diary.hit }</td>
									<td><fmt:formatDate value="${Diary.regdate }" pattern="yyyy-MM-dd"/></td>
									<td><fmt:formatDate value="${Diary.updateDate }" pattern="yyyy-MM-dd"/></td>
								</tr>
